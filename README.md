...
# 
# Note: `cross requires additional configuration to pass through
# the environment variables that are generated by the build process.
# Read "During build" below for more information.
